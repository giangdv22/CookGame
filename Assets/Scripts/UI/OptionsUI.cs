...
public class OptionsUI : MonoBehaviour
{
    ...
    private void Start()
    {
        KitchenGameManager.Instance.OnLocalGamePaused += KitchenManager_OnGamePaused;
        UpdateVisual();
        Hide();
    ...
    private void UpdateVisual()
    {
        ...
        musicText.text = "Music: " + Mathf.Round(MusicManager.Instance.GetVolume() * 10.0f).ToString();
