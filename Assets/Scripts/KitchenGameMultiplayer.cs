...
public class KitchenGameMultiplayer : NetworkBehaviour
{
    ...
    private const string PLAYER_PREFS_PLAYER_NAME_MULTILAYER = "PlayerNameMultiplayer";
    ...
    private void Awake()
    {
        ...
        playerName = PlayerPrefs.GetString(PLAYER_PREFS_PLAYER_NAME_MULTILAYER, "PlayerName" + UnityEngine.Random.Range(100, 1000));
    ...
    public void SetPlayerName(string playerName)
    {
        ...
        PlayerPrefs.SetString(PLAYER_PREFS_PLAYER_NAME_MULTILAYER, playerName);
    }
